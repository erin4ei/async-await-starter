...
function displayUsers(output, id, data){
    ...
    // TODO: divide the data returned into four arrays
    for (let i = 0; i < 12; i++){
        if(i < 3){
    ...
    function displayPage(currentPage){
        // TODO - complete the code to display the JSON data to the page
...
// TODO - Complete the code to call the API and display the returned data on the page in the correct place
...
// TODO - Complete the code to call the API using an async function
async function getUsers(){
    let response = await fetch("https://randomuser.me/api/?results=12&nat=us,gb");

    //throw an error if error is in response
    if (response.error){
...
// TODO - Complete the code to handle the data returned from the API and display the returned data on the page in the correct place
getUsers()
    .then(json => {
        console.log(json);
